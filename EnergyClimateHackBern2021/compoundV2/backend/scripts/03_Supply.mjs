...
// Declare a const Variable to pass to the mint Function of the FakecDai contract
const MINT_AMOUNT = web3.utils.toHex("1000000000000000000000");
console.log("5. The const variable has been declared");

// Create the encoded ABI of the mint function
const mintEncodedABI = FakecDaiContractInstance.methods
  .mint(MINT_AMOUNT)
  .encodeABI();
...
web3.eth.getTransactionCount(ADDRESS_ALICE).then(transactionNonce => {
    ...
    console.log("9. The Transaction for Supply has been executed")
},
