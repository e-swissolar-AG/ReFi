...
// Declare a const Variable to pass to the borrow Function of the FakecDai contract
const BORROW_AMOUNT = web3.utils.toHex("1000000000000000000000");
console.log("5. The const variable has been declared");

// Create the encoded ABI of the borrow function
const borrowEncodedABI = FakecDaiContractInstance.methods
  .borrow(BORROW_AMOUNT)
  .encodeABI();
  console.log("6. ABI encoded for borrow");
