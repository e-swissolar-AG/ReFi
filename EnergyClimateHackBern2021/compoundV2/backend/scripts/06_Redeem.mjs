...
const REDEEM_AMOUNT = web3.utils.toHex("2500000000000");
console.log("5. The const variable has been declared");

// Create the encoded ABI of the redeem function
const redeemEncodedABI = FakecDaiContractInstance.methods
...
web3.eth.getTransactionCount(ADDRESS_ALICE).then(transactionNonce => {
    ...
    console.log("9. The Transaction for Redeem has been executed")
},
